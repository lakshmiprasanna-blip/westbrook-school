...
export default function ContactSection() {
          ...
          <div className="bg-primary px-8 sm:px-12 lg:px-16 py-12 flex flex-col justify-center">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                className="w-full h-[48px] px-4 bg-[#E5E5E5] rounded-md text-[14px] font-medium focus:outline-none"
              />
  ...
  <select
    ...
    className={`w-full h-[48px] px-4 pr-10 bg-[#E5E5E5] rounded-md text-[14px] font-medium focus:outline-none appearance-none ${
