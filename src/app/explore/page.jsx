    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6">
      ...
      {[
        ...
        >
          ...
          {/* Circle */}
          <div className="w-24 h-24 sm:w-[104px] sm:h-[104px] md:w-28 md:h-28 mx-auto mb-5 md:mb-6 bg-[#F7F6F2] rounded-full" />

          <div
            className="mb-3 leading-[110%] text-[18px] sm:text-[20px] md:text-[21px]"
            style={{
              fontFamily: "Playfair Display, serif",
              fontWeight: 700,
            }}
          ...
          <div
            className="leading-[22px] sm:leading-[24px] text-[14px] sm:text-[15px]"
            style={{
